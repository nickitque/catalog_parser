...
def crawl_products(pages_count):
    """Принимает количество страниц с карточками товаров,
    а возвращает список ссылок на товары с этих страниц"""
    urls = []
...
def parse_products(urls):
    """Принимает список урлов,парсит информацию по каждому товару и добавляет
    её в общий массив data, который и возвращает"""
    data = []
    for url in urls:
